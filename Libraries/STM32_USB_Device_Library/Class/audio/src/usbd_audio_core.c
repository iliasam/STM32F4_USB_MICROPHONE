...
extern int16_t RecBuf0[MIC_FILTER_RESULT_LENGTH]; //сюда попадают отфильтрованные PCM данные от микрофона
extern int16_t RecBuf1[MIC_FILTER_RESULT_LENGTH]; //сюда попадают отфильтрованные PCM данные от микрофона
